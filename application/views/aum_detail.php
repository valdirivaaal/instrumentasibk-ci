	...
	<div class="col-md-12">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				?>
				<a class="btn btn-primary btn-sm float-right ml-2" target="_blank" href="<?= base_url('aum/laporan_kelas/' . $id) ?>"><i class="fa fa-book"></i> Cetak Laporan Kelas</a>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a class="btn btn-sm btn-primary individu-download" data-nama="<?= $value['nama_lengkap'] ?>" target="_blank" href="<?= base_url('aum/laporan_individu/' . $value['id']) ?>"><i class="fa fa-file"></i> Cetak Laporan</a>
