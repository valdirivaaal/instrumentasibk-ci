<div class="row">
	<div class="col-md-12">
		<div class="panel-body bio-graph-info">
			<h1 class="font-weight-bold"> Daftar <?= (getField('user_info', 'status', array('user_id' => $this->session->userdata('id'))) == 'Guru BK') ? 'Guru' : 'Konselor' ?></h1>
		</div>
		<div class="card">
			<div class="card-header">
				Data <?= (getField('user_info', 'status', array('user_id' => $this->session->userdata('id'))) == 'Guru BK') ? 'Guru' : 'Konselor' ?>
			</div>
			<div class="card-body">
				<?php
