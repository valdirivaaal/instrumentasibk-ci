      ...
      <aside class="profile-nav col-lg-3">
        <section class="card">
          <div class="user-heading round">
            <img src="<?= (@$get_profil[0]['foto']) ? base_url('uploads/foto_profil/'.$this->session->userdata('id').'/'.$get_profil[0]['foto']) : base_url('assets/member/img/profile-avatar.jpg') ?>" class="img-fluid" alt="">
