          ...
          <tbody>
            ...
            foreach ($get_jawaban as $value) {
              ...
              <tr>
                ...
                <td><a class="btn btn-sm btn-primary" href="<?= base_url('ptsdl/laporan_individu/'.$value['id']) ?>"><i class="fa fa-file"></i> Cetak Laporan</a><button type="button" class="btn btn-sm btn-danger ml-2"><i class="fa fa-trash-o"></i> Hapus</button></td>
              </tr>
              <?php
            }
            ?>
