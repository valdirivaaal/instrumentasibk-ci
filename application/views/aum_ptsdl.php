          ...
          <tbody>
           ...
           foreach ($kelas as $key => $value_kelas) {
            ...
            <tr class="gradeX">
              ...
              <td><a class="btn btn-sm btn-primary ml-2" href="<?= base_url('ptsdl/view/'.$value_kelas['id']) ?>"><i class="fa fa-eye"></i> Buka</a><button type="button" class="btn btn-sm btn-danger ml-2"><i class="fa fa-trash-o"></i> Hapus</button></td>
            </tr>
            <?php
          }
          ?>          
