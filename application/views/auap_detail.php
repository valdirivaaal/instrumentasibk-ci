						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a class="btn btn-sm btn-primary individu-download" data-nama="<?= $value['nama_lengkap'] ?>" target="_blank" href="<?= base_url('auap/laporan_individu/' . $value['id']) ?>"><i class="fa fa-file"></i> Cetak Laporan</a>
