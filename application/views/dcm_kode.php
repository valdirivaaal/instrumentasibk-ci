<div class="row">
	<div class="col-md-12">
		<div class="panel-body bio-graph-info">
			<h1 class="font-weight-bold">Kode Unik DCM</h1>
		</div>
		<div class="alert alert-info" role="alert">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					?>
					<form action="<?= base_url('dcm/kode_save') ?>" method="post">
							...
							<div class="col-md-12">
								<div class="input-group mb-3">
									<div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon3">https://instrumentasibk.com/dcm/</span>
									</div>
									<input type="text" class="form-control" name="kode_singkat" id="basic-url" aria-describedby="basic-addon3" placeholder="Masukkan kode singkat anda disini" value="<?= (isset($get_dcm[0]['kode_singkat'])) ? $get_dcm[0]['kode_singkat'] : random_string('alnum', 5) ?>">
								</div>
							</div>
						</div>
						<div class="form-group">
